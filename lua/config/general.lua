...
-- vim.cmd [[
-- autocmd BufWritePost *.tex :silent exec '!pdflatex -output-directory="/tmp/" -jobname="temp-autogenerated" <afile>' |
--     silent exec '!mv /tmp/temp-autogenerated.pdf ~/Downloads'
-- ]]
-- END --
...
-- slow down saving and opening buffers but it enables safer updates to swapfile
-- and undofile (avoid to have empty file after crash)
-- vim.cmd [[
--     set fsync
-- ]]
